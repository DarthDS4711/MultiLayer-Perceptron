...
class Window:
   ...
   # función para mostrar la información por pantalla
    ...
    def train(self):
        ...
        self.__mlp.set_data(self.__pointsBuilder.dataClass1,
            self.__pointsBuilder.dataClass2, self.__pointsBuilder.dataClass3)
    ...
    def class_flower_green(self):
        self.__pointsBuilder.change_class(0.5)

    # inicialización de manera aleatoria de los pesos del perceptron
    def inicialize_random(self):
        self.__mlp.inicialize_weigths()
        self.__pointsBuilder.update_lines(self.__mlp.get_weigths_first_hidden_layer())
